...
def wideresnet_partial(depth=28, widen_factor=4, num_classes=1000, part=1.0,zero_fixed_part=False,do_init=True):
    """
    Construct ResNeXt-152.
    """
    return WideResNet_partial(depth=depth, num_classes=num_classes, widen_factor=widen_factor,
                              part=part,zero_fixed_part=zero_fixed_part,do_init=do_init)
